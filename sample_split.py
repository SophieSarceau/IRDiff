...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default=root_dir+'/sampled_results/n128k3')
    ...
    for data_id in range(args.start_index, args.end_index + 1):
        ...
        pred_pos, pred_v, pred_pos_traj, pred_v_traj, pred_v0_traj, pred_vt_traj, time_list = sample_diffusion_ligand(
            model, data, prompt_data, prompt_data_2, prompt_data_3, num_samples=args.num_samples,
